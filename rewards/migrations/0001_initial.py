    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('brand_country', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='rewards.brandcountry')),
            ],
        ),
        migrations.CreateModel(
            name='Reward',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price_type', models.CharField(choices=[('Range', 'Range'), ('Fixed', 'Fixed'), ('Multivalue', 'Multivalue')], max_length=20)),
